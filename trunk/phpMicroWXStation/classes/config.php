...
define('OK', 'OK'); // This is bit of a hack for ajax, just leave it here, I'll remove it in the future sometime
define('DEBUG_MODE', true);
define('RANDOM_CHARS', 'AaBbCcDd1EeFf2GgHh3IiJj4KkLl5MmNn6oPp7QqRr8SsTt9UuVvWwXxYyZz'); // Characters used to make random image names for upload
